<?php
 ...
 {  
        include('../config.php');
        if (isset($_POST["code"])) {
            $stmt="SELECT id,email,verification_code,is_admin FROM `users` WHERE id=(?) AND deleted_at IS NULL LIMIT 1";
            ...
            if ($result) {
                ...
                while ($row= mysqli_fetch_array($data)) {
                    ...
                    if ($_POST["code"]== $row["verification_code"]) {
                            ...
                            $verified=1;
                            //binding the parameters to prepard statement
                            mysqli_stmt_bind_param($sql,"ii",$verified,$_SESSION["student_id"]);
        
                            $result=mysqli_stmt_execute($sql);
                            if ($result) {
                                // setcookie("verification_code", 86885, time() + (1), "/");
                                ...
                                if ($row['is_admin']==0) { // if student
                                    ...
                                    echo "<script>alert('Successfully Account Verified.');
...
<body>
    <div class="container">
        <div class="container__forms">
            <div class="form">
                <form action="./verify_account.php" method="post" class="form__sign-in">
        ...
        <div class="container__panels">
            <div class="panel panel__left">
                <div class="panel__content">
                    ...
                    Please use the 4 digit code mailed to you on <?php echo $_SESSION['student_email'];?>
                    </p>
                ...
                <img class="panel__image"
                    src="../../frontend/images/signup.png" alt="" />
            </div>
