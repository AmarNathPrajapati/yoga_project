<?php
 ...
 include('../config.php');
    ...
    {  
        if (isset($_POST["code"])) {
            ...
            if ($data->num_rows> 0 ){
               ...
               if ($forgot_token==$_POST["code"]) {
                $code_match=true;
                $user_id=$row["id"];
                // echo "<script>alert('Success!! Code Match.');
                // </script>";
               }
               else{
                // echo "hello";
    ...
    if (isset($code_match) && $code_match==true) {
        ?>
...
<body>
    ...
    <div class="container">
        ...
        <form id="login_form" action="./set_new_password.php"  method="post">
            <h3>Enter New Password</h3>

            <input hidden type="number" name="user_id" value="<?php echo $user_id;?>">
            <input required type="password" id="password" name="password" placeholder="Enter New Password">
        ...
        <div class="container__panels">
            <div class="panel panel__left">
                <div class="panel__content">
                    <h3 class="panel__title" style="color: black;">Reset Your Password</h3>
