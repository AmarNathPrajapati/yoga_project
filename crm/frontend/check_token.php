        ...
        <div class="container__panels">
            <div class="panel panel__left">
                <div class="panel__content">
                    <h3 class="panel__title" style="color: black;">Enter Your Code</h3>
                    <p class="panel__paragraph" style="color: black;">
                        You received a 4 digit code on your registered email, use that to reset your password.
                    </p>
