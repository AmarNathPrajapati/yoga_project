                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Manage Case Study</h1>
                            </div>
                            <!-- Actions -->
                                                                ...
                                                                <div class="col-12 text-center">
                                                                    <?php
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                ?>
                                                                                    <img src="../../documents/case_study/<?php echo $row["file"];?>" style="max-width:100%; height:200px; margin:auto; object-fit:cover;"alt="img">
                                                                                <?php
                                                                            }
